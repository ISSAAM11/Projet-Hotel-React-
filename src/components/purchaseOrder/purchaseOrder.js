...
export default function PurchaseOrder() {
  ...
  const handleDelete = (id) => {
    axios.delete(`http://localhost:3000/purchase-orders/${id}`,config ).then(
      res => {
        forceUpdate()
      },
      err => {
      ...
      <div className="container-fluid ">
        <div className="row mb-2">
          <div className="col-sm-6">
            <h1 className="m-0 text-dark">{t("Commande")}</h1>
          </div>{/* /.col */}
        </div>{/* /.row */}
        <hr></hr>
      </div>{/* /.container-fluid */}
        ...
        <div className="card-header ">
          <table >
            ...
            <tr>
                ...
                <input className="form-control form-control-navbar col-md-20" ref={inputEl} onChange={getSearchTerm} type="search" placeholder={t("Nom de l'Hotel, admin, date ...")} aria-label="Search" />
                </th>
                ...
                <Link to="./AddPurchaseOrder">
                    <Button variant="primary" type="button" style={{ whiteSpace: 'nowrap' }}>
          ...
          <table id="example2" className="table  ">
            ...
            {Loading ?
                <tbody>
                  <tr>
                    <td colSpan={3}></td>
                    <td className="ml-5" ><center> {t("Chargement")}  <Spinner animation="border " variant="primary" /></center></td>
                    <td colSpan={3}></td>
                  </tr>
                </tbody>
