...
<div className="card">
  <div className="card-header">
    <h3 className="card-title mt-2">{t("Montant des hôtels par mois")}</h3>

     <Dropdown className="float-right">
        <Dropdown.Toggle  variant="white" id="dropdown-basic"> {t("Année")}: {selectedYear} </Dropdown.Toggle>
...
{/*         <Dropdown.Item ><a type="button"className="nav-link active" aria-current="page"onClick={()=>DeviceAmountChart("all")} >Tout</a></Dropdown.Item>*/}          
            ...
            <Dropdown.Item ><a type="button"className="nav-link active" aria-current="page"onClick={()=>DeviceAmountChart("gateway")} >{t("Dispositif réseau")}</a></Dropdown.Item>
            ...
            <Dropdown.Item ><a type="button"className="nav-link active" aria-current="page"onClick={()=>DeviceAmountChart("energy")} >{t("Mode éco")}</a></Dropdown.Item>
          </Dropdown.Menu>
        </Dropdown>
  </div>
